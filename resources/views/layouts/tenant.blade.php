...
@else
<li class="nav-item">
    <a class="nav-link" href="{{ route('tenant.login', ['prefix' => \Request::route('prefix')]) }}">{{ __('Login') }}</a>
</li>
@if (Route::has('register'))
<li class="nav-item">
    <a class="nav-link" href="{{ route('tenant.register', ['prefix' => \Request::route('prefix')]) }}">{{ __('Register') }}</a>
</li>
@endif
@endguest
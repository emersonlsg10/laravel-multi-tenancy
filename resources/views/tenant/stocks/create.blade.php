    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('tenant.stocks.register', ['prefix' => \Request::route('prefix')]) }}">
                    {{ csrf_field() }}
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" class="form-control" id="payment_form" name="payment_form" placeholder="Forma de pagamento">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Valor da unidade</label>
                            <input required type="text" class="form-control" id="unit_value" name="unit_value" placeholder="Valor da unidade">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="phone">Valor do estoque</label>
                            <input required type="text" class="form-control" id="stock_value" name="stock_value" placeholder="Valor do estoque">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">

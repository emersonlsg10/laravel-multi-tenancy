    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('tenant.budgets.register', ['prefix' => \Request::route('prefix')]) }}">
                    {{ csrf_field() }}
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select id="id_service" name="id_service" class="form-control">
                                ...
                                <option value="{{$service->id}}">{{$service->model}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input min="0" required type="number" class="form-control" id="quantity" name="quantity">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Metragem</label>
                            <input min="0" required type="number" step="0.01" class="form-control" id="budget_footage" name="budget_footage">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" class="form-control" id="payment_budget" name="payment_budget">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Data da fatura</label>
                            <input required type="text" class="form-control" id="budget_invoice" name="budget_invoice">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="phone">Tipo de orçamento</label>
                            <input required type="text" class="form-control" id="budget_type" name="budget_type">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
